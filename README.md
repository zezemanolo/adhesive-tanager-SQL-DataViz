...
## Context
#### For Newbie and Intermediate Learners
This goal gives you the opportunity to learn how to set up a database on back end server, hook it up to a front end/browser, and render your data to the browser.( It is a first step towards learning how to set up CRUD (Create, Read, Update, and Delete) for a database, as it asks only for implementation of "Read" functionality.) You will also learn how to use [Postgres](https://www.postgresql.org/about/), mySQL, or a similar database management system (DBMS)
...
More advanced learners wishing to work with REACT may build this using REACT, MongoDB for their database, and use  [D3](https://d3js.org/) for their data visualization. These learners may wish to refer to FreeCodeCamp's forthcoming unit on ["Data Visualization"](https://www.freecodecamp.com/map).
